  ...
  return (
    <LandingLayout>
      <main className="pt-22 pb-[102px] gap-6 w-full max-w-[1249px] mx-auto font-(family-name:--font-poppins) flex flex-col md:flex-row justify-center md:justify-between">
        <div className="flex flex-col gap-10 md:gap-20 px-3.5 w-full md:w-1/2 xl:w-2/5 items-center md:items-left">
          <div className="flex flex-col gap-5">
            <div>
              <h1 className="font-bold text-4xl md:text-[64px]">Contact Us</h1>
            ...
            <ul className="flex flex-col gap-4 font-medium opacity-80 text-sm md:text-base">
              <li>
          ...
          <div className="flex flex-col xs:flex-row md:flex-col lg:flex-row gap-5 self-start">

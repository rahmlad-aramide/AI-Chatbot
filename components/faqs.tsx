...
export const FAQs = () => {
  ...
  return (
    <section
      id="faq"
      className="flex flex-col gap-4 md:gap-16 font-(family-name:--font-inter) py-6 md:py-24 container mx-auto"
    >
      <div className="flex flex-col gap-1 md:gap-5 w-full px-4.5 max-w-[768px] md:px-10 mx-auto">
        <h2 className="text-2xl md:text-4xl font-semibold text-center">
          Frequently asked questions
        </h2>
        <p className="text-base md:text-xl text-[#667085] text-center">
        ...
        {data.map((item, idx) => (
          <Accordion type="single" collapsible key={idx}>
            <AccordionItem value={item.q}>
              ...
              <AccordionContent className="text-xs md:text-base text-[#667085]">
                {item.a}
              </AccordionContent>
            </AccordionItem>
          </Accordion>
